namespace qmr
{
    ...
    export class ModuleManager
    {
        ...
        public static closeAllWindow(): void
        {
            ...
            sp = LayerManager.instance.getLayer(LayerConst.MASK_UI);
            while (sp.numChildren)
            {
                win = sp.getChildAt(0) as DisplayObjectContainer;
                t.disposWin(win);
            ...
            /**关闭2级界面 */
            sp = LayerManager.instance.getLayer(LayerConst.SECOND_PAGE_UI);
            while (sp.numChildren)
            {
                win = sp.getChildAt(0) as DisplayObjectContainer
                t.disposWin(win);
        ...
        public static setupClass()
        {
            ...
            t.registerClass(ModuleNameLogin.CREATEROLE_VIEW, qmr.CreateRoleView); 
